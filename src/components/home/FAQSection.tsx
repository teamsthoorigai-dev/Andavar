...
const FAQS = [
  {
    ...
    aTa: "மங்கலான பார்வை, கண் வலி, அடிக்கடி தலைவலி அல்லது உங்கள் பார்வையில் திடீர் மாற்றம் ஏற்பட்டால், தாமதிக்காமல் பரிசோதனை செய்துகொள்ளுங்கள். எந்த அறிகுறியும் இல்லாவிட்டாலும், ஓரிரு ஆண்டுகளுக்கு ஒரு முறை வழக்கமான கண் பரிசோதனை செய்துகொள்வது நல்லது.",
  },
  {
    ...
    aTa: "குளுக்கோமா, கண்புரை, நீரிழிவு விழித்திரை நோய் போன்றவை ஆரம்ப அறிகுறிகள் இல்லாமல் மௌனமாக உருவாகக்கூடும். வழக்கமான பரிசோதனைகள் இந்த மாற்றங்களை ஆரம்பத்திலேயே கண்டறியும் — அப்போதுதான் சிகிச்சை எளிதாக இருக்கும், பார்வையிழப்பையும் தடுக்க முடியும்.",
  },
  {
    qEn: "What are the early signs of glaucoma?",
    qTa: "குளுக்கோமாவின் (கண் அழுத்த நோய்) ஆரம்ப அறிகுறிகள் என்ன?",
    ...
    aTa: "குளுக்கோமா பெரும்பாலும் எந்தக் குறிப்பிடத்தக்க அறிகுறியும் இல்லாமல் உருவாகும், பார்வை ஏற்கனவே பாதிக்கப்பட்ட பிறகே தெரியவரும் — இதனால்தான் இது 'பார்வையின் மௌனத் திருடன்' என்று அழைக்கப்படுகிறது. நிரந்தர பாதிப்பு ஏற்படுவதற்கு முன் இதை ஆரம்பத்திலேயே கண்டறிய, வழக்கமான கண் அழுத்தப் பரிசோதனையே நம்பகமான வழி.",
  },
  {
    ...
    aEn: "Cataract surgery typically takes 15–30 minutes and is done as a day-care procedure using No Injection, No Suture techniques, so most patients go home the same day. With proper pre-operative evaluation, it is one of the safest and most commonly performed surgeries in the world.",
    aTa: "கண்புரை அறுவை சிகிச்சை பொதுவாக 15–30 நிமிடங்கள் ஆகும், ஊசி இல்லாத, தையல் இல்லாத முறையில் ஒரு நாள் சிகிச்சையாகவே செய்யப்படுகிறது — எனவே பெரும்பாலான நோயாளிகள் அன்றே வீடு திரும்புவார்கள். சரியான முன் பரிசோதனையுடன் செய்யப்படும்போது, இது உலகின் மிகவும் பாதுகாப்பான, அதிகம் செய்யப்படும் அறுவை சிகிச்சைகளில் ஒன்று.",
  },
  {
    ...
    aTa: "மங்கலான இயற்கை லென்ஸ் அகற்றப்பட்ட பிறகு, அதற்குப் பதிலாக ஒரு செயற்கை லென்ஸ் (IOL) பொருத்தப்படும். சாதாரண மோனோஃபோகல் லென்ஸ்கள் தொலைவுப் பார்வையைச் சரிசெய்யும், அதே சமயம் பிரீமியம் லென்ஸ் தேர்வுகள் அருகிலும் நடுத்தர தூரத்திலும் பார்ப்பதற்குக் கண்ணாடி அணிய வேண்டிய தேவையையும் குறைக்கும்.",
  },
  {
  ...
  },
  {
    ...
    aTa: "பெரும்பாலான நோயாளிகள் ஓரிரு நாட்களுக்குள் எளிய தினசரி வேலைகளைத் தொடங்கலாம், சில நாட்களுக்குள் பார்வை தெளிவடையத் தொடங்கும். கண் சொட்டு மருந்துகள், பாதுகாப்புக் கண்ணாடி மற்றும் வாகனம் ஓட்டுதல் அல்லது கடின வேலைகளை எப்போது தொடங்கலாம் என்பது குறித்து உங்கள் அறுவை சிகிச்சை நிபுணர் தெளிவான வழிகாட்டுதல் தருவார்.",
  },
  {
    ...
    aEn: "Diabetics should have a dilated retina check-up at least once every 6 months, even without symptoms, since diabetic retinopathy can silently damage the retina. If diabetic retinopathy is found, a check-up once every 3 months is recommended.",
    aTa: "நீரிழிவு நோயாளிகள் அறிகுறி இல்லாவிட்டாலும் குறைந்தது 6 மாதங்களுக்கு ஒரு முறை, கண்மணியை விரிவாக்கி விழித்திரைப் பரிசோதனை செய்துகொள்ள வேண்டும், ஏனெனில் நீரிழிவு விழித்திரை நோய் (டயாபடிக் ரெட்டினோபதி) அறிகுறியின்றி விழித்திரையைப் பாதிக்கக்கூடும். நீரிழிவு விழித்திரை நோய் கண்டறியப்பட்டால், 3 மாதங்களுக்கு ஒரு முறை பரிசோதனை செய்துகொள்ள வேண்டும்.",
  },
];
